  ...
  render() {
    return (
      <View style={styles.itemsList}>
         <TouchableOpacity onPress = {() => this.props.navigation.navigate('EditOrg', this.props.item)}>
            ...
            <Text style={styles.itemtext}>${this.props.item.price + ' '}</Text>
              {this.props.item.bought == true ? <Text style={styles.itemtext}> Bought </Text> : (null) }
         </TouchableOpacity>
